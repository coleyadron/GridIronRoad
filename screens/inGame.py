...
prePicture = pygame.image.load("assets/images/pregames.png")
postPicture = pygame.image.load("assets/images/postgame.png")
...
def updateScoreboard(screen):
    ...
    screen.blit(prePicture, (0, 0))

    preText = "Week " + str(WEEK) + " vs " + OPPOSING_TEAM + "!"
    pregameText = font.render(preText, True, (255, 255, 255))
    screen.blit(pregameText, (screen.get_width() / 2 - pregameText.get_width() / 2, 75))
